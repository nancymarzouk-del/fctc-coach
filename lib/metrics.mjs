...
// ============================================================================
// Mock exam blueprint — a GENERAL weighted-allocation helper.
// ----------------------------------------------------------------------------
// This is a reusable allocator: given per-domain subskills and weights, it returns
// exactly `total` items { domain, subskill, difficulty }, covering every subskill
// at mixed difficulty and deterministically interleaved so domains mix like a real
// exam. It asserts NO weighting of its own. The OFFICIAL FCTC section weighting
// (A/B/C/D = 20/25/20/35) lives in the governed blueprint (lib/fctcBlueprint.mjs)
// and is applied by buildMockPlan(), which passes officialWeights() here.
// `domainSubskills` = { domain: [subskillKey, ...] }.
