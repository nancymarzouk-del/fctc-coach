...
import * as sie from './certifications/sie/sieBlueprint.mjs';
import * as tm from './certifications/tm/tmBlueprint.mjs';
...
export const CERTIFICATIONS = {
  ...
  'finra-sie': {
    ...
    name: sie.CERT_NAME,
    kind: 'professional-knowledge',
    blueprintSource: sie.BLUEPRINT_SOURCE,
    practiceLabel: sie.PRACTICE_LABEL,
    domainOrder: sie.TOPIC_ORDER,
    domains: sie.TOPICS,
    subskillBlueprint: sie.SUBSKILL_BLUEPRINT,
    officialWeights: sie.officialWeights,
    officialAllocation: (total) => sie.officialMockAllocation(total),
    examSeconds: sie.EXAM.minutes * 60,
    calculatorAllowed: sie.CALCULATOR_ALLOWED,
    provenanceFor: sie.provenanceFor,
  },
  // A reusable SKILL domain (not a certification) — proves the shared engine scores
  // behavioral execution skills through the same metricsRegistryFor seam. No exam.
  'time-management': {
    id: tm.CERT_ID,
    name: tm.CERT_NAME,
    kind: tm.KIND,
    blueprintSource: tm.BLUEPRINT_SOURCE,
    practiceLabel: tm.PRACTICE_LABEL,
    domainOrder: tm.TOPIC_ORDER,
    domains: tm.TOPICS,
    subskillBlueprint: tm.SUBSKILL_BLUEPRINT,
    officialWeights: tm.officialWeights,
    officialAllocation: (total) => tm.officialMockAllocation(total),
    examSeconds: null,
    calculatorAllowed: tm.CALCULATOR_ALLOWED,
    provenanceFor: tm.provenanceFor,
  },
};
